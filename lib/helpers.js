...
/* How many snapshot PAYLOADS are held in memory at once. Each one is a whole
   subtree plus every table it embeds, so this is the heaviest cache in the
   app; browsing a long history used to keep every payload it touched alive for
   the life of the tab. They are all re-fetchable, so the ceiling is cheap. */
var VERSION_CACHE = 24;
var GUTTER = {
