...
AlamzaParts.register(class {
  extraVals() {
    ...
    return {
      ...
      inviteOff: !String(m.email || '').trim() || !AStore.cloud,
      inviteColor: (!String(m.email || '').trim() || !AStore.cloud) ? 'var(--faint)' : 'var(--text)',
      inviteRole: 'viewer',
      ...
      shareIsLive: AStore.cloud,
      shareModeNote: AStore.cloud
